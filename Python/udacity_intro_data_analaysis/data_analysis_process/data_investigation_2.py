...
enrollment_num_unique_students = count_unique_student(enrollments)
print "Number of unique students in enrollment:", enrollment_num_unique_students

engagement_num_rows = len(daily_engagement)
print "Number of rows in daily engagement:", engagement_num_rows
engagement_num_unique_students = count_unique_student(daily_engagement)
...
submission_num_unique_students = count_unique_student(project_submissions)
